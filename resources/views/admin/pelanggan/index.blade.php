<x-admin-layout>
   ...
   <div id="content-container"  class="content-container ml-64">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="" class="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-md hover:from-blue-600 hover:to-purple-600 transition duration-300 flex items-center shadow-lg transform hover:scale-105">
