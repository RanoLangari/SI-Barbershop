    ...
    <div id="content-container" class="content-container ml-64">
        ...
        <div class="flex justify-end mb-4">
            <form action="" method="GET" class="flex items-center">
                <label for="month" class="mr-2 text-gray-700">Pilih Bulan:</label>
                <input type="month" id="month" name="month" class="border border-gray-300 rounded-md p-2">
                <button type="submit" class="ml-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Cari</button>
            </form>
        </div>

        <div class="flex justify-end mb-4">
            <a href="" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">Cetak Laporan</a>
        </div>

        <p class="text-center text-gray-500">Tidak ada data laporan untuk bulan yang dipilih.</p>
