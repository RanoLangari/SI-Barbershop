...
<head>
    ...
    <title>SI Barbershop - Login</title>
    ...
    <div
        ...
        <div class="relative w-full max-w-md px-6 py-10 flex flex-col items-center justify-center">
            ...
            <div
                ...
                <h2 class="text-2xl font-semibold text-center text-black dark:text-white mb-6">Masuk ke Akun</h2>
                ...
                <form id="loginform" action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <a href="#"
                            class="text-sm text-[#FF2D20] hover:text-[#FF2D20]/80 transition duration-300 focus-visible:ring-1 focus-visible:ring-[#FF2D20] focus:outline-none">
                            Lupa Password?
                        </a>
                    </div>
